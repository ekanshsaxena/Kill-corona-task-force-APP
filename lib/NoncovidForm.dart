...
class NonCovidPatientForm extends StatefulWidget {
  @override
  NonCovidPatientFormState createState() {
    return NonCovidPatientFormState();
  }
}

class NonCovidPatientFormState extends State<NonCovidPatientForm> {
  ...
  addData() async {
    ...
    var url = "http://chkctf.org/api/create/noncovid";
    Dio dio = new Dio();
